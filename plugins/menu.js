...
█░▀░█ █▀▄ █▄",
    ...
    // This Commands For WhatsApp Bussinuss
    //   throw `
    // ┌〔 DAFTAR MENU 〕
    // ├ ${_p + command} all
    // ├ ${_p + command} game
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), '
█░█░█ █ ▀█▀ █░█   █░░ █▀█ █░█ █▀▀   █▀▄▀█ █▀█ ▀█
▀▄▀▄▀ █ ░█░ █▀█   █▄▄ █▄█ ▀▄▀ ██▄   █░▀░█ █▀▄ █▄', 'Do you KnOw Who Is The owNer', `${_p}owner`, 'Git and Grup link', `${_p}git`, m)
  } catch (e) {
