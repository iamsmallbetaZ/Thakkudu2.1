...
const defaultMenu = {
  before: `
  〔 ᴵᵗ'ᶻ ᴹᵉ ᵀʰᵃᵏᵏᵘᵈᵘ ᵂᴬ ᴮᵒᵀ〕
➪Hai, %name!
➪Uptime: *%uptime (%muptime)*
➪Developer:ᴵᵗ'ˢ ᴹᵉ ᴹᴿ_ᶻ
%readmore`.trimStart(),
  header: '*[ %category ]*',
  body: '✰ %cmd %islimit %isPremium',
  footer: '\n*[ Pls Subscribe PBA MODS ]*\n',
  after: `
*ᴵᵃᵐ ᵀʰᵃᵏᵏᵘᵈᵘ ᵂᴬ ᴮᵒᵀ ᴴᵃᵖᵖʸ ᵗᵒ ᴴᵉˡᵖ ʸᵒᵘ🦄*
*𝐻𝑎𝑣𝑒 𝐴 𝑛𝑖𝑐𝑒 𝐷𝑎𝑦🦄*
`,
}
  ...
  try {
    ...
    if (teks == '404') {
      return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          "title": `      🔮 ᴵᵗ'ᶻ ᴹᵉ ᵀʰᵃᵏᵏᵘᵈᵘ ᵂᴬ ᴮᵒᵀ 🔮\n\╭─❑\n\│✅ Version: v1 \n\│✅ Library: Baileys\n\│✅ Runtime: ${uptime} \n\╰❑\n\╭─⭐ 「 INFO USER 」\n\│ 👤 Name: ${name} \n\│ 🔍 Total Features : 100+\n\│ ⚠️ Limit: ${limit} \n\│ 🗓️ Date: ${date} \n\│ 🔰 Exp: ${exp} \n\│ 💎 Level: ${level} \n\│ 🔮 Role: ${role} \n\│ 📟 Storage: 106/128 Gb \n\╰⭐\n\╭─ ❑「 INFORMATION 」❑──\n\│ This bot is a WA BoT By Mr_z\n\│ if there is a bug \ error please\n\│ report it to the owner\n\│\n\╰❑`.trim(),
          "description": "ᴅᴏɴᴛ sᴘᴀᴍ",
          "buttonText": "Click Here",
          "footerText": "ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴵᵗ'ˢ ᴹᵉ ᴹᴿ_ᶻ",
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Mᴀᴅᴇ Wɪᴛʜ ❤️ Fʀᴏᴍ PBA MODS TEAM', 'Cʀᴇᴀᴛᴏʀ😯', `${_p}owner`, '𝐺𝐼𝑇 & 𝑊𝐴 𝐺𝑅𝑈𝑃 𝐿𝐼𝑁𝐾', `${_p}git`, m)
  } catch (e) {
